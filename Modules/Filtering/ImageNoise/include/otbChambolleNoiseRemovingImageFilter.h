...
#ifndef __otbChambolleNoiseRemovingImageFilter_h
#define __otbChambolleNoiseRemovingImageFilter_h
...
/*
 * \class ChambolleNoiseRemovingImageFilter
...
class ITK_EXPORT ChambolleNoiseRemovingImageFilter :  public itk::ImageToImageFilter<TInputVectorImage, TInputVectorImage>
{
...
public:
  ...
  typedef ChambolleNoiseRemovingImageFilter                                           Self;
  ...
  /** typemacro */
  itkTypeMacro(ChambolleNoiseRemovingImageFilter, ImageToImageFilter);
...
protected:
  ChambolleNoiseRemovingImageFilter();
  virtual ~ChambolleNoiseRemovingImageFilter() {}
...
private:
  ChambolleNoiseRemovingImageFilter(const Self &); //purposely not implemented
...
#include "otbChambolleNoiseRemovingImageFilter.txx"
#endif
